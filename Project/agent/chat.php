            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <h2 class="mt-1">Chat With Admins</h2>
                        <ol class="breadcrumb mb-4 bg-light p-2">
                            <li class="breadcrumb-item active"><i class="fa fa-comment"></i> Chat With Admins</li>
                                        ...
                                        $result = $db->executeQuery($query);
                                            ...
                                            if($result->num_rows){
                                                ...
                                                while($row = mysqli_fetch_assoc($result)){
                                                    ?>
                                                     <li  class="pe-auto list-group-item disabled itemClick text-primary " id="<?php echo $row['admin_id'] ?>">  <img src="https://cdn-icons-png.flaticon.com/512/9200/9200701.png" width="10%" class="img img-thumbnail img-responsive"/>  <?php echo $row['name'] ?></li>
                                                    <?php
                                                }
                                            }
                                            echo "</ul>";
