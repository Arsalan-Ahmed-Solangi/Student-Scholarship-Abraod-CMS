            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <h2 class="mt-1">Add Site Admin</h2>
                        <ol class="breadcrumb mb-4 bg-light p-2">
                            <li class="breadcrumb-item active"><i class="fa fa-user-cog"></i> Add Site Admin</li>
                        ...
                        <div class="card shadow-sm bg-white p-2">
                            <div class="card-body p-3">
                                <form id="form" action="classes/add_admin.php" method="POST">
                                    ...
                                    <div class="form-group mb-2 mt-2 offset-md-11">
                                       <button type="submit" class="btn btn-danger btn-sm" name="addAdmin">Add</button>
                                    </div>
                                </form>
                            </div>
                        </div>
