                    ...
                    <div class="sb-sidenav-menu">
                        <div class="nav" style="font-size:14px">
                            ...
                            <div class="collapse" id="degreeLayout" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                             ...
                             <!-- Students  -->
                             <a class="nav-link collapsed" href="#" data-bs-toggle="collapse" data-bs-target="#courseLanguage" aria-expanded="false" aria-controls="courseLanguage">
                                <div class="sb-nav-link-icon"><i class="fa fa-language"></i></div>
                                Languages
                                <div class="sb-sidenav-collapse-arrow"><i class="fas fa-angle-down"></i></div>
                            </a>
                            <div class="collapse" id="courseLanguage" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="view_languages"> View Languages</a>
