                                ...
                                <form id="form" action="classes/scholarship.php" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="row mt-2">
                                        ...
                                        <div class="col-md-6 col-xs-12 col-sm-12 col-lg-6">
                                            ...
                                            <input type="file" name="image[]" accept="image/*" class="form-control" required multiple/>
                                            <span class="form-text text-success">select multiple images for institute</span>
                                        </div>
                                    </div>
