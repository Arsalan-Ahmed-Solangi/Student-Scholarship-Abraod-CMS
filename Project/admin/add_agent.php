            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <h2 class="mt-1">Add Agent</h2>
                        <ol class="breadcrumb mb-4 bg-light p-2">
                            <li class="breadcrumb-item active"><i class="fa fa-plus-circle"></i> Add Agent</li>
                                ...
                                <form id="form" action="classes/agent.php" method="POST" enctype="multipart/form-data">
                                   ...
                                   <div class="row">
                                    ...
                                    <div class="form-group mb-2 mt-2 offset-md-11">
                                       <button type="submit" class="btn btn-danger btn-sm" name="addAgent">Add</button>
                                    </div>
                                </form>
                            </div>
                        </div>
