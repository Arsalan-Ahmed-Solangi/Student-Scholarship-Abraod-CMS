            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        ...
                        $id = $_GET['id'];
                        $query = "SELECT * FROM `degrees` WHERE degree_id='$id'";
                        $result = $db->executeQuery($query);
                        $row = mysqli_fetch_assoc($result);
                        
                        ?>
                        <h2 class="mt-1">Edit Degree Title</h2>
                        <ol class="breadcrumb mb-4 bg-light p-2">
                            <li class="breadcrumb-item active"><i class="fa fa-user-cog"></i> Edit Degree Title</li>
                            ...
                            <div class="card-body p-3">
                                <form id="form" action="classes/degree.php" method="POST">
                                    <div class="form-group mb-2 mt-2">
                                        ...
                                        <input value="<?php echo $row['degree_name'] ?>" type="text" name="name" placeholder="E.g " class="form-control" required/>
                                    </div>

                                    <div class="form-group mb-2 mt-2 offset-md-9">
                                       <button type="submit" class="btn btn-danger btn-sm" name="editDegree">Save & Update</button>
                                    </div>
                                </form>
                            </div>
                        </div>
